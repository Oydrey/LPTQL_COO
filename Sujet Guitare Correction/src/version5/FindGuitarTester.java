...
public class FindGuitarTester {
	...
	public static void initializeInventory(Inventory inventory) {
      ...
      inventory.addInstrument(new Mandoline("V95693", 1499.95,
                new MandolineSpec(Builder.FENDER, "Stratocastor", Style.A, Type.ELECTRIC, Wood.ALDER, Wood.ALDER)));
      ...
      inventory.addInstrument(new Mandoline("77023", 6275.95,
                new MandolineSpec(Builder.MARTIN, "D-28", Style.A, Type.ACOUSTIC, Wood.BRAZILIAN_ROSEWOOD, Wood.ADIRONDACK)));
      ...
      inventory.addInstrument(new Mandoline("6 29584", 2100.95,
                new MandolineSpec(Builder.PRS, "Dave Navarro Signature", Style.F, Type.ELECTRIC, Wood.MAHOGANY, Wood.MAPLE)));
	}
